...
public class SearchingAndSortingAlgorithms {
	...
	/**
	 * Create the methods in the Algorithm class so that it will make the following tests pass. When you get a green
	 * bar, uncomment the next test until you have solved them all. Expand your vocabulary while you're at it.
	 **/

	/* 1. Create a method that will find return the first index of a broken egg */
	// bc of Algorithms.findBrokenEgg(eggs)
	@Test
